...
def kill_chrome():
    if os.name == "posix" or os.name == "mac" or os.name == "linux" or os.name == "darwin":
        os.system("killall -9 'Google Chrome for Testing'")
    elif os.name == "nt":
...
def mian():
    ...
    chrome_driver_path = "prepare/prepare_cache/chromedriver"
